...
$(document).ready(function () {
	function UpdateSong() {
		$.get("/song/description.json", function( songdetails ) {
			lovedstring = "";
			...
			$( "#cursongdescription" ).html( songdetails.songtitle + " by " + songdetails.songartist + " on " + songdetails.songalbum + lovedstring);
		});
	};
	function DoPost(url){
